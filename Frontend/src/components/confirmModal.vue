...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="bg-dark-khaki-400 border border-gray-100/30 font-poppins relative flex h-50 w-100 flex-col items-center justify-center gap-4 rounded-lg text-white"
      >
